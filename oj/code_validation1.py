...
def check_code(submission):
    with open("F:\Algouniversity\onlinejudge\oj\Testcases\question1\sol.cpp", "w") as f:
        f.write(submission.code)
    f.close()
    if sys.platform == 'linux':
        command =['g++ sol.cpp']
    else:
        path_to_code = r"F:\Algouniversity\onlinejudge\oj\Testcases\question1"
    ...
    for i in range(n):
        ...
        try:
            ...
            return
        f.close()
        out1="F:\Algouniversity\onlinejudge\oj\Testcases\question1\output.txt"
